...
public class Form {
	...
	private Boolean onSubmit(Event event) {
		...
		document.getElementById("a").textContent = getInput("a").value;
		document.getElementById("b").textContent = getInput("b").value;
		document.getElementById("operator").textContent = getInput("operator").value;
